...
document.writeln(`<h3 class="text-center display-4">Se comprobará si el número ${numero} es par o impar:</h3>`);
document.writeln(`<p class="text-center text-success display-5">${resultado}</p>`);
